		...
		<div class="container"><div class="ic">More Website Templates at TemplateMonster.com!</div>
			<div class="inside">
				<div class="wrapper indent">
					<article class="col-1">
				<%
				String url = "/TSRH/filetracking/file/historyquery.org?fileId="+(String) request.getAttribute("fileId");
				%>
					<h2>History of file</h2>
								<form name="historyform" action="<%=url%>" method="post">
			<table>

			<tr>
				<td><h3>From:</h3></td>
				<td><input name="Sdate" type="text" value="yyyy-mm-dd" id="date1" class="three" />
</td>
</tr>
			<tr>
				<td><h3>To:</h3></td>
				<td><input name="Edate" value="yyyy-mm-dd"type="text" id="date2" class="three" />
</td>
</tr>
		</table>
