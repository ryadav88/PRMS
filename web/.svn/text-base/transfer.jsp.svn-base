...
<title>File tracking Page | Transfer form</title>
<meta charset="utf-8"/>
...
<!-- content -->
<% String fileId = (String) request.getAttribute("fileId");
  String url = "/TSRH/filetracking/file/transferquery.org?fileId=" + fileId;
		...
		<div class="container"><div class="ic">More Website Templates at TemplateMonster.com!</div>
			<div class="inside">
				<div class="wrapper indent">
					<article class="col-1">
					<h2>Transfer form</h2>
			<form name="transferform" action="<%=url%>" method="post">
			<table>
		    <tr>
...
<%} %>
			...
			<tr>
				<td ><h3>Date:</h3></td>
				<td><input type="radio" name="date" value="Today" onClick="clicktoday()"/> Now (or) &nbsp;&nbsp;
				<input type="radio"  name="date"value="Range of dates" onClick="clicked()"/>Specify Date<br/><br/>
				
				<div id="datedisplay" style="visibility:hidden">&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="Tdate" value="yyyy-mm-dd" id="date1" class="three" /><br/><br/></div></td>
				
				<td><div id="datedisplay1" style="visibility:hidden"><h3>Time: (hh:mm)</h3>
				<select name="Ttimeh" id="timeH">
				<option value="--">--</option>
			...
			<tr>
				<td  height="40"><h3>Return Date:</h3></td>
				<td><input name="Rdate" value="yyyy-mm-dd" id="date2" class="three" /></td>
			</tr>
			<tr>
				<td height="40"><h3>Return Time: (hh:mm) </h3></td>
			...
			<tr>
				...
				<td><select name="locationLevel2" id="locationoption">
					<option selected="selected" value="CMT">CMT</option>
